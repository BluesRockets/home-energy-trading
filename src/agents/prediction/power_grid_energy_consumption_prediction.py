...
model_data_path = '../../test/agents/prediction/combined_hourly_data_no_time.csv'
...
prediction_data_path = '../../data/input/solar_hourly_energy_production_dataset.xlsx'
...
output_path = '../../data/output/production/solar_hourly_energy_predictions.xlsx'
